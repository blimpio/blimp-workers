...
wget -qO- https://raw.github.com/GetBlimp/blimp-workers/master/provisioning/setup.sh | bash -s $9
...
wget -qO- https://raw.github.com/GetBlimp/blimp-workers/master/provisioning/firewall.sh | bash -s $3 $5 $7 $9
